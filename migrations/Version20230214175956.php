 ...
 */
final class Version20230214175956 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories_pictures (categories_id INT NOT NULL, pictures_id INT NOT NULL, INDEX IDX_598286F9A21214B7 (categories_id), INDEX IDX_598286F9BC415685 (pictures_id), PRIMARY KEY(categories_id, pictures_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE categories_pictures ADD CONSTRAINT FK_598286F9A21214B7 FOREIGN KEY (categories_id) REFERENCES categories (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE categories_pictures ADD CONSTRAINT FK_598286F9BC415685 FOREIGN KEY (pictures_id) REFERENCES pictures (id) ON UPDATE NO ACTION ON DELETE CASCADE');
